...
constexpr auto qt_meta_stringdata_CLASSExportDialogENDCLASS = QtMocHelpers::stringData(
    "ExportDialog",
    "selectDirectoryOutput",
    "",
...
Q_CONSTINIT const QMetaObject ExportDialog::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSExportDialogENDCLASS_t,
        ...
        // method 'selectDirectoryOutput'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'selectDirectoryResources'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
    >,
    nullptr
} };
...
void ExportDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->selectDirectoryOutput(); break;
        case 1: _t->selectDirectoryResources(); break;
        default: ;
        }
    }
    (void)_a;
